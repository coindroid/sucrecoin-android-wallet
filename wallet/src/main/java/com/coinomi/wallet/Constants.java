...
import com.coinomi.core.coins.SucrecoinMain;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/Sucrecoin/Sucrecoin/releases";

    public static final String VERSION_URL = "https://sucrecoin.io//version";
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(SucrecoinMain.get(), new ServerAddress("80.211.187.186", 21001),
                    new ServerAddress("80.211.187.186", 21001))
    ...
    static {
        ...
        COINS_ICONS.put(CoinID.SUCRECOIN_MAIN.getCoinType(), R.drawable.sucrecoin);


        COINS_BLOCK_EXPLORERS = new HashMap<>();
        COINS_BLOCK_EXPLORERS.put(CoinID.SUCRECOIN_MAIN.getCoinType(), "http://explorer.sucrecoin.org/tx/%s");
    }
